...
pictureString
   : (pictureSpecifier pictureCardinality?)+
   ;

/* Corrected to remove ( ), IDENTIFIER 
   from the picture chars */ 

pictureChars
   : DOLLARCHAR | ACHAR | VCHAR | PCHAR | SCHAR | XCHAR | NINECHAR | SLASHCHAR | COMMACHAR | DOT | COLONCHAR | ASTERISKCHAR | PLUSCHAR | MINUSCHAR | LESSTHANCHAR | MORETHANCHAR | integerLiteral
   ;

pictureSpecifier
   : integerPictureSpecifier | doublePictureSpecifier | stringPictureSpecifier
   ; 

integerPictureSpecifier
   : INTEGERPICTURE
   ; 

doublePictureSpecifier
   : DOUBLEPICTURE
   ; 

stringPictureSpecifier
   : IDENTIFIER
   ; 
...
INTEGERPICTURE : SCHAR? NINECHAR+;

DOUBLEPICTURE : SCHAR? (NINECHAR | VCHAR | PCHAR)+;
